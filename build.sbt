...
lazy val scraps: Project = (project in file("."))
  .settings(common)
  .settings(
    organization := "com.github.winitzki",
    version := "0.0.1",

    licenses := Seq("Apache License, Version 2.0" -> url("https://www.apache.org/licenses/LICENSE-2.0.txt")),
    homepage := Some(url("https://github.com/winitzki/scala-scraps")),
    description := "Bits and pieces of useful Scala code",
    ...
    libraryDependencies ++= Seq(
      "org.scala-lang" % "scala-reflect" % scalaVersion.value % Test // Just in case.
